...
Again, because this is a six hour workshop, and we have a lot to cover, we ask that you come prepared with
...
`Intro_R_KSU_Fall2019-master/` with the folowing structure:
...
[Workshop Materials]: https://github.com/mehraKSU/Intro_R_KSU_Fall2019/archive/master.zip
